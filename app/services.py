...
def api_reference_pdf() -> bytes:
    ...
    def draw_page_chrome(pdf_canvas: Any, page_number: int) -> None:
        ...
        pdf_canvas.drawString(0.58 * inch, A4[1] - 0.27 * inch, "VANTAGE RISK  /  SCORING API REFERENCE")
    ...
    document = BaseDocTemplate(
        ...
        title="Vantage Risk Scoring API Reference",
        author="Vantage Risk",
    )
    story: list[Any] = [
        Paragraph("Vantage Risk", styles["brand"]),
